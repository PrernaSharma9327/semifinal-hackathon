...
function interleave(map) {
      ...
      if (style.getState() === H.map.Style.State.READY) {
        ...
        // Add a circular transparent layer around an added place
         ...
         var circle = new H.map.Circle(
          {lat: 22.27473200680024, lng:73.22620537623608}, // Coordinates of the added place
          700, // Radius of the circle in meters
          { style: {fillColor: 'rgba(0, 0, 255, 0.3)', strokeColor: 'rgba(0, 0, 255, 1)', lineWidth: 2} } // Transparent fill color
        );
        map.addObject(circle);
        
        var circle = new H.map.Circle(
          {lat: 22.310948956521678, lng:73.16035259133113}, // Coordinates of the added place
          700, // Radius of the circle in meters
          { style: {fillColor: 'rgba(0, 0, 255, 0.3)', strokeColor: 'rgba(0, 0, 255, 1)', lineWidth: 2} } // Transparent fill color
        );
        map.addObject(circle);
        ...
        var circle = new H.map.Circle(
          {lat: 22.297908312257505, lng:73.13583912148633}, // Coordinates of the added place
          700, // Radius of the circle in meters
          { style: {fillColor: 'rgba(0, 0, 255, 0.3)', strokeColor: 'rgba(0, 0, 255, 1)', lineWidth: 2} } // Transparent fill color
        );
        map.addObject(circle);
  ...
  var map = new H.Map(document.getElementById('map'),
    ...
    center: {lat:22.27473200680024, lng:73.22620537623608},
    zoom: 13,
  ...
  var additionalPlaces = [
   // Example additional place 1
    ...
    {lat:22.27473200680024, lng:73.22620537623608},
    {lat:22.310948956521678, lng:73.16035259133113},
    {lat: 22.297908312257505, lng:73.13583912148633}
